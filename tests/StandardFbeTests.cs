    ...
    public class StandardFbeTests{
        ...
        public void FloatingCotFixedFfpTest(){
            ...
            foreach (var cot in cotArray){
                ...
                var station = new StandardFbe("STANDARD FBE", simulation, channel, fbeTimes, 0);
        ...
        public void WithOffset(){
            ...
            foreach (var cot in cotArray){
                ...
                var fbeTimes = new FBETimes(9, cot, ffp);
                var channel = new Channel();
                var station1 = new StandardFbe("STANDARD FBE 1", simulation, channel, fbeTimes, 0);
                var station2 = new StandardFbe("STANDARD FBE 1", simulation, channel, fbeTimes, 2500);
                var station3 = new StandardFbe("STANDARD FBE 1", simulation, channel, fbeTimes, 5000);
                var station4 = new StandardFbe("STANDARD FBE 1", simulation, channel, fbeTimes, 7500);
